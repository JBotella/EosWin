<div class="dropdown selectorAcciones">
	...
	<div class="dropdown-menu dropdown-menu-left listaSelectorAcciones" aria-labelledby="accionesTabla">
		<div class="dropdown-item"><i class="fas fa-list-alt mr-1"></i>@lang('texto.extracto')</div>
		<div class="dropdown-item"><i class="fas fa-file-export mr-1"></i>@lang('texto.exportar')</div>
