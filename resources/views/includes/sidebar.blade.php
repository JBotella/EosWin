	...
	<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
		<div class="sb-sidenav-menu">
			<div class="nav mt-3">
				...
				<a class="nav-link @if(in_array($vActual,['apuntesPeriodicos','apuntePeriodico'])) nav-link-selected @endif" href="{!!route('apuntesPeriodicos')!!}">
				...
				<a class="nav-link @if(in_array($vActual,['utilidades','utilidadListado','listaUtilidad','utilidadFormulario'])) nav-link-selected @endif" href="{!!route('utilidades')!!}">
