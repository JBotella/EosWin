					...
					<div class="col-12 col-md-6 col-lg-4 col-xl-4 mt-0" id="declaraciones_informativas">
						...
						<div class="row m-0">
							@component('components.tarjetaLibrosOficiales')
								...
								@slot('icono','')
								@slot('nombre',trans('texto.libros_oficiales.ventas.libro_oficial_ventas.nombre'))
								@slot('resumen',trans('texto.libros_oficiales.ventas.libro_oficial_ventas.resumen'))
								@slot('link','libro_oficial_ventas')
							@endcomponent
							@component('components.tarjetaLibrosOficiales')
								@slot('class','estilo-tarjeta-azulAnalogo')
								@slot('icono','')
								@slot('nombre',trans('texto.libros_oficiales.ventas.resumen_iva_repercutido.nombre'))
								@slot('resumen',trans('texto.libros_oficiales.ventas.resumen_iva_repercutido.resumen'))
								@slot('link','resumen_iva_repercutido')
							@endcomponent
							@component('components.tarjetaLibrosOficiales')
								@slot('class','estilo-tarjeta-azulAnalogo')
								@slot('icono','')
								@slot('nombre',trans('texto.libros_oficiales.ventas.libro_facturas_expedidas.nombre'))
								@slot('resumen',trans('texto.libros_oficiales.ventas.libro_facturas_expedidas.resumen'))
					...
					<div class="col-12 col-md-6 col-lg-4 col-xl-4 mt-0" id="suministro_inmediato_informacion">
						...
						<div class="row m-0">
							@component('components.tarjetaLibrosOficiales')
								...
								@slot('icono','')
								@slot('nombre',trans('texto.libros_oficiales.otros.libro_oficial_suplidos.nombre'))
								@slot('resumen',trans('texto.libros_oficiales.otros.libro_oficial_suplidos.resumen'))
								@slot('link','libro_oficial_suplidos')
							@endcomponent
							@component('components.tarjetaLibrosOficiales')
								@slot('class','estilo-tarjeta-moradoAnalogo')
								@slot('icono','')
								@slot('nombre',trans('texto.libros_oficiales.otros.libro_oficial_provision_fondos.nombre'))
								@slot('resumen',trans('texto.libros_oficiales.otros.libro_oficial_provision_fondos.resumen'))
								@slot('link','libro_oficial_provision_fondos')
							@endcomponent
							@component('components.tarjetaLibrosOficiales')
								@slot('class','estilo-tarjeta-moradoAnalogo')
								@slot('icono','')
								@slot('nombre',trans('texto.libros_oficiales.otros.libro_bienes_inversion.nombre'))
								@slot('resumen',trans('texto.libros_oficiales.otros.libro_bienes_inversion.resumen'))
								@slot('link','libro_bienes_inversion')
							@endcomponent
							@component('components.tarjetaLibrosOficiales')
								@slot('class','estilo-tarjeta-moradoAnalogo')
								@slot('icono','')
								@slot('nombre',trans('texto.libros_oficiales.otros.cuenta_resultado.nombre'))
								@slot('resumen',trans('texto.libros_oficiales.otros.cuenta_resultado.resumen'))
								@slot('link','cuenta_resultado')
							@endcomponent
							@component('components.tarjetaLibrosOficiales')
								@slot('class','estilo-tarjeta-moradoAnalogo')
								@slot('icono','')
								@slot('nombre',trans('texto.libros_oficiales.otros.exportar_libros_formato_excel.nombre'))
								@slot('resumen',trans('texto.libros_oficiales.otros.exportar_libros_formato_excel.resumen'))
