...
{{-- abreForm('{{route("utilidadFormAsinc","operaciones-contables",$item->$ident)}}'); --}}
	<tr class="trClicable fila" id="{{$item->$ident}}" onclick="abreForm('{{route("utilidadFormAsinc",["operaciones-contables",$item->$ident])}}')">
