	...
	<div class="bloqueFormulario">
		<div class="row">
			...
			@component('components.itemFormulario')
				...
				@slot('nombre', trans($parametros->textos.'.campos.porcentajeIva'))
				@slot('valor')
			...
			@component('components.itemFormulario')
				@slot('class', 'col-12 col-md-12 col-lg-12 col-xl-4')
				@slot('nombre', trans($parametros->textos.'.campos.porcentajeRe'))
				@slot('valor')
					<input type="number" class="form-control" name="RecaIVA" @if($datos) value="{{number_format($datos->RecaIVA,2)}}" @endif />
				@endslot
			@endcomponent
			@component('components.itemFormulario')
				@slot('class', 'col-12 col-md-12 col-lg-12 col-xl-4')
