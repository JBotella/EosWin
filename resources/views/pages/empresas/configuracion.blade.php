				...
				<form class="form" method="POST" action="{!!route('guardaEmpresa')!!}">
					...
					<div class="row">
						<div class="col-12 col-md-6" id="columnaIzquierda">
							{{-- Datos generales --}}
							<div class="categoriaBloqueFormulario">@lang('configuraciones.form_empresa.datos_generales')</div>
							<div class="bloqueFormulario">
								<div class="row">
									@component('components.itemFormulario')
										@slot('class', 'col-12 col-md-12 col-lg-12 col-xl-12')
										@slot('nombre', trans('configuraciones.form_empresa.codigo'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										@slot('class', 'col-12 col-md-12 col-lg-12 col-xl-12')
										@slot('nombre', trans('configuraciones.form_empresa.nombre'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										...
										@slot('nombre', trans('configuraciones.form_empresa.nif_cif'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										@slot('class', 'col-4 col-md-4 col-lg-4 col-xl-3')
										@slot('nombre', trans('configuraciones.form_empresa.cnae'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										@slot('class', 'col-12 col-md-12 col-lg-12 col-xl-12')
										@slot('nombre', trans('configuraciones.form_empresa.actividad'))
										@slot('valor')
							...
							{{-- Domicilio --}}
							<div class="categoriaBloqueFormulario">@lang('configuraciones.form_empresa.domicilio')</div>
							<div class="bloqueFormulario">
								<div class="row">
									@component('components.itemFormulario')
										@slot('class', 'col-12 col-md-12 col-lg-12 col-xl-12')
										@slot('nombre', trans('configuraciones.form_empresa.direccion'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										...
										@slot('nombre', trans('configuraciones.form_empresa.numero'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										@slot('class', 'col-3 col-md-3 col-lg-3 col-xl-3')
										@slot('nombre', trans('configuraciones.form_empresa.escalera'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										@slot('class', 'col-3 col-md-3 col-lg-3 col-xl-3')
										@slot('nombre', trans('configuraciones.form_empresa.piso'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										@slot('class', 'col-3 col-md-3 col-lg-3 col-xl-3')
										@slot('nombre', trans('configuraciones.form_empresa.puerta'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										...
										@slot('nombre', trans('configuraciones.form_empresa.codigo_postal'))
										@slot('valor')
											<input type="text" class="form-control" name="cp" value="{{$datosEmpresa->MECP}}" data-href="{{ route('listaLocalidadesMin') }}" onclick="listaExtra(this)" />
										@endslot
									@endcomponent
									@component('components.itemFormulario')
										@slot('class', 'col-6 col-md-6 col-lg-6 col-xl-6')
										@slot('nombre', trans('configuraciones.form_empresa.localidad'))
										@slot('valor')
											<input type="text" class="form-control" name="localidad" value="{{$datosEmpresa->MELOCALIDAD}}" data-href="{{ route('listaLocalidadesMin') }}" onclick="listaExtra(this)" />
										@endslot
									@endcomponent
									@component('components.itemFormulario')
										@slot('class', 'col-6 col-md-6 col-lg-6 col-xl-6')
										@slot('nombre', trans('configuraciones.form_empresa.provincia'))
										@slot('valor')
											<input type="text" class="form-control" name="provincia" value="{{$datosEmpresa->MEPROVINCIA}}" data-href="{{ route('listaLocalidadesMin') }}" onclick="listaExtra(this)" />
										@endslot
									@endcomponent
								</div>
							</div>
							{{-- Contacto --}}
							<div class="categoriaBloqueFormulario">@lang('configuraciones.form_empresa.contacto')</div>
							<div class="bloqueFormulario">
								<div class="row">
									@component('components.itemFormulario')
										@slot('class', 'col-12 col-md-12 col-lg-12 col-xl-12')
										@slot('nombre', trans('configuraciones.form_empresa.email'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										@slot('class', 'col-6 col-md-6 col-lg-6 col-xl-6')
										@slot('nombre', trans('configuraciones.form_empresa.telefono'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										@slot('class', 'col-6 col-md-6 col-lg-6 col-xl-6')
										@slot('nombre', trans('configuraciones.form_empresa.fax'))
										@slot('valor')
						...
						<div class="col-12 col-md-6" id="columnaDerecha">	
							{{-- AEAT --}}
							<div class="categoriaBloqueFormulario">@lang('configuraciones.form_empresa.aeat')</div>
							<div class="bloqueFormulario">
								<div class="row">
									@component('components.itemFormulario')
										@slot('class', 'col-6 col-md-6 col-lg-6 col-xl-6')
										@slot('nombre', trans('configuraciones.form_empresa.cp_administracion'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										@slot('class', 'col-6 col-md-6 col-lg-6 col-xl-6')
										@slot('nombre', trans('configuraciones.form_empresa.delegacion'))
										@slot('valor')
									...
									@component('components.itemFormulario')
										@slot('class', 'col-6 col-md-6 col-lg-6 col-xl-6')
										@slot('nombre', trans('configuraciones.form_empresa.administracion'))
										@slot('valor')
								...
								<div class="row">
									@component('components.itemFormulario')
										@slot('class', 'col-12 col-md-12 col-lg-12 col-xl-12')
										@slot('nombre', trans('configuraciones.form_empresa.criterio_caja'))
										@slot('valor')
											<div class="itemCheckbox custom-control custom-checkbox pl-3">
												...
												<label class="custom-control-label" for="criterioCaja">
													@lang('configuraciones.form_empresa.criterio_caja_label')
												</label>
											</div>
										@endslot
									@endcomponent
